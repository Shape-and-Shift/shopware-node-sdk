...
import { types, object } from '../service/util.service';

export const enum TOTAL_COUNT_MODE {
...
interface RequestParams {
  ...
  'total-count-mode'?: TOTAL_COUNT_MODE,
}
...
export class Criteria {
  ...
  private totalCountMode: TOTAL_COUNT_MODE | null;
  ...
  constructor(page = 1, limit = 25) {
    ...
    this.grouping = [];
    this.groupFields = [];
    this.totalCountMode = TOTAL_COUNT_MODE.EXACT_TOTAL_COUNT;
  }
   ...
   */
  setTotalCountMode(mode: TOTAL_COUNT_MODE): this {
  ...
  hasAssociation(property: string): boolean {
    return this.associations.some((association) => {
      return association.association === property;
    });
  }
